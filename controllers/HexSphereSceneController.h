...
public:
    ...
    const QSet<int>& getTreeOccupiedCells() const { return treeOccupiedCells_; }
    void updateTreeOccupiedCells(); // ќбновить список €чеек с деревь€ми
