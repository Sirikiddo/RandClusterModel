...
bool shouldPlaceTree(Biome biome, std::mt19937& gen) {
    ...
    case Biome::Savanna:
        return true;
    case Biome::Snow:
        return dist(gen) < 0.4f;
    case Biome::Tundra:
        return dist(gen) < 0.25f;
    default:
        return false;
    }
}
...
std::vector<TreePlacement> buildTreePlacements(const TerrainSnapshot& snapshot) {
    ...
    placements.reserve(cells.size() / 2);
    ...
    return proc::GraphSchemaBuilder::compile(
        ...
        },
        {
            proc::GraphSchemaBuilder::NodeDef{
                ...
                {"selectionOutline", "selectionDirty", "selectionCacheHit"},
            ...
            proc::GraphSchemaBuilder::NodeDef{
                ...
                {"treePlacements", "treeDirty", "treeCacheHit"},
            ...
            proc::GraphSchemaBuilder::NodeDef{
                ...
                {"modelPlacements", "modelDirty", "modelCacheHit"},
        ...
        registry.bind_executor(
            ...
            *selectionNode,
            [this,
             ...
             dirtySlot = *selectionDirtySlotLocal,
             cacheHitSlot = *selectionCacheHitSlot](
                ...
                commit.set(dirtySlot, "0", proc::v2::WriteLifetime::Persistent, std::string(schema.field_name(dirtySlot)));
