...
std::pair<int, int> HexGrid::getHexAtPosition(float x, float y) {
    ...
    // Ïðîâåðÿåì êàíäèäàòîâ ñ ïîìîùüþ àëãîðèòìà îïðåäåëåíèÿ ïîïàäàíèÿ â ìíîãîóãîëüíèê
